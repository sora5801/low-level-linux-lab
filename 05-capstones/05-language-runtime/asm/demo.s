...
.LBB0_4:                                # =>This Inner Loop Header: Depth=1
	movslq	%eax, %rsi
	decl	%eax
	movq	-328(%rbp,%rsi,8), %r8
	addq	%r8, -336(%rbp,%rsi,8)
	movslq	%edx, %rsi
	incl	%edx
	addq	%rdi, %rsi
	movzbl	(%rsi), %esi
...
.LBB0_6:                                # =>This Inner Loop Header: Depth=1
	movslq	%eax, %rsi
	decl	%eax
	movq	-336(%rbp,%rsi,8), %r8
	xorl	%r9d, %r9d
	cmpq	-328(%rbp,%rsi,8), %r8
	setle	%r9b
	movq	%r9, -336(%rbp,%rsi,8)
	movslq	%edx, %rsi
	incl	%edx
	addq	%rdi, %rsi
	movzbl	(%rsi), %esi
